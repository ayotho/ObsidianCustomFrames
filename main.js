...
var CustomFrame = class {
  constructor(settings, data, onFaviconUpdated) {
  ...
  create(parent, additionalStyle = void 0, urlSuffix = void 0) {
    ...
    if (import_obsidian.Platform.isDesktopApp && !this.data.forceIframe) {
      ...
      this.frame.addEventListener("page-favicon-updated", (event) => {
        var _a, _b;
        let favicon = (_a = event.favicons) == null ? void 0 : _a[0];
        if (favicon)
          (_b = this.onFaviconUpdated) == null ? void 0 : _b.call(this, favicon);
      });
...
var _CustomFrameView = class extends import_obsidian3.ItemView {
  ...
  updateFavicon() {
    let tabHeader = this.leaf.tabHeaderEl;
    let icon = tabHeader == null ? void 0 : tabHeader.querySelector(".workspace-tab-header-inner-icon");
